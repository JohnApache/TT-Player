...
(function (global, factory) {
  ...
  (global = global || self, global.TTPlayerCore = factory());
  ...
  ***************************************************************************** */
  ...
  var USES_TO_LENGTH$1 = arrayMethodUsesToLength('every');
  ...
  var every_1 = function (it) {
    var own = it.every;
    return it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.every) ? every : own;
  };
  ...
  var some_1 = function (it) {
    var own = it.some;
    return it === ArrayPrototype$4 || (it instanceof Array && own === ArrayPrototype$4.some) ? some : own;
  };
  ...
  /* Created By @dking/hasaki-cli */
  var BrowserUtils = {
    createDom: function createDom(tagName) {
      var dom = document.createElement(tagName);
      return dom;
    },
    findDom: function findDom(selector) {
      if (typeof document.querySelector === 'function') {
        return document.querySelector(selector);
      }

      if (startsWith$2(selector).call(selector, '#')) {
        return document.getElementById(slice$2(selector).call(selector, 1));
      }

      if (startsWith$2(selector).call(selector, '.')) {
        return document.getElementsByClassName(slice$2(selector).call(selector, 1))[0];
      }
  ...
  function () {
    ...
    createClass(DOMUtils, [{
      key: "hasClass",
      value: function hasClass(className) {
        var _context;

        if (this.element.classList) {
          return some$2(Array.prototype).call(this.element.classList, function (item) {
            return item === className;
          });
        }

        return some$2(_context = this.classList).call(_context, function (item) {
          return item === className;
        });
      }
    }, {
      ...
      value: function addClass(className) {
        ...
        var classList = trim$2(className).call(className).split(/\s+/g);

        if (this.element.classList) {
          forEach$2(classList).call(classList, function (item) {
            item && _this.element.classList.add(item);
          });
        } else {
          this.element.className += " ".concat(classList.join(' '));
        }
      ...
      value: function removeClass(className) {
        ...
        if (this.element.classList) {
          forEach$2(classList).call(classList, function (item) {
            _this2.element.classList.remove(item);
          });
        } else if (this.hasClass(className)) {
          var _context2;

          this.element.className = filter$2(_context2 = this.classList).call(_context2, function (item) {
            return every$2(classList).call(classList, function (v) {
              return v !== item;
            });
          }).join(' ');
        }
      ...
      value: function setStyles(styles) {
        ...
        forEach$2(_context3 = keys$3(styles)).call(_context3, function (item) {
          _this3.setStyle(item, styles[item]);
        });
      ...
      value: function setAttributes(attributes) {
        ...
        forEach$2(_context4 = keys$3(attributes)).call(_context4, function (attr) {
          _this4.setAttribute(attr, attributes[attr]);
        });
      ...
      key: "findDom",
      value: function findDom(selector) {
      ...
      get: function get() {
        ...
        return trim$2(_context5 = this.element.className).call(_context5);
      }
    }, {
      key: "classList",
      get: function get() {
      ...
      key: "createUtilDom",
      value: function createUtilDom(tagName) {
  ...
  var Options = function Options(options) {
    ...
    if (typeof this.width === 'number') {
      this.width = "".concat(this.width, "px");
    }
  ...
  /*#__PURE__*/
  function () {
    function TTPlayerCore(options) {
      classCallCheck(this, TTPlayerCore);
    ...
    createClass(TTPlayerCore, [{
      ...
      key: "init",
      value: function init() {
        this.installPlugins().render().ready();
      }
    }, {
      key: "ready",
      ...
      value: function render() {
        this.renderContainer().renderPlugins();
        return this;
      }
    }, {
      key: "renderContainer",
      value: function renderContainer() {
        ...
        this.root.addClass('ttplayer--container').setStyles({
          width: width,
          height: height
      ...
      value: function renderPlugins() {
        ...
        forEach$2(_context2 = this.plugins).call(_context2, function (plug) {
          return plug.render && plug.render();
        });
      }
    }, {
      key: "installPlugins",
      value: function installPlugins() {
        ...
        forEach$2(_context3 = this.pluginsCtor).call(_context3, function (plug) {
          var plugInstance = new plug(_this);
          _this.pluginsMap[plug.pluginName] = plugInstance;
      ...
      key: "use",
      value: function use(ctor) {
        var installed = this.installedPluginsMap[ctor.pluginName];
