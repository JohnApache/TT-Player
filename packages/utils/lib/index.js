...
(function (global, factory) {
	...
	(global = global || self, factory(global.TTPlayerUtils = {}));
	...
	*/
	...
	var some_1 = function (it) {
	  var own = it.some;
	  return it === ArrayPrototype$3 || (it instanceof Array && own === ArrayPrototype$3.some) ? some : own;
	};
	...
	function () {
	  ...
	  createClass(DOMUtils, [{
	    ...
	    value: function setStyles(styles) {
	      ...
	      forEach$2(_context3 = keys$2(styles)).call(_context3, function (item) {
	    ...
	    value: function setAttributes(attributes) {
	      ...
	      forEach$2(_context4 = keys$2(attributes)).call(_context4, function (attr) {
	...
	exports.bUtils = BrowserUtils;
	exports.dUtils = DOMUtils;
	exports.utils = BaseUtils;
