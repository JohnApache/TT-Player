...
(function (global, factory) {
  ...
  */
  ...
  var every_1 = function (it) {
    var own = it.every;
    return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.every) ? every : own;
  };
  ...
  var VideoOptions = function VideoOptions(options) {
    var _context,
        _this = this;

    classCallCheck(this, VideoOptions);
  ...
  /*#__PURE__*/
  function () {
    function TTPlayerVideo(player) {
      classCallCheck(this, TTPlayerVideo);
    ...
    createClass(TTPlayerVideo, [{
      key: "init",
      value: function init() {
        this.bindEvents().initVideoStyle().initVideoMedia();
        return this;
      }
    }, {
      key: "initVideoStyle",
      value: function initVideoStyle() {
        this.video.addClass('ttplayer--video');
        return this;
      }
    }, {
      key: "initVideoMedia",
      value: function initVideoMedia() {
        var _this$options = this.options,
            src = _this$options.src,
            volume = _this$options.volume,
            muted = _this$options.muted;
        this.setVideoSrc(src).setVolume(volume).setMuted(muted);
        return this;
      }
    }, {
      key: "setVideoSrc",
      value: function setVideoSrc(src) {
        ...
        var video = this.video.getInstance();
        ...
        forEach$2(src).call(src, function (item) {
          var source = BrowserUtils.createDom('source');
